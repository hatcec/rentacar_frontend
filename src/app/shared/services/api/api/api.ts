...
export const APIS = [AdminControllerService, AuthenticationControllerService, BrandsControllerService, CarsControllerService, FuelsControllerService, ModelsControllerService, TransmissionsControllerService, UserControllerService];
