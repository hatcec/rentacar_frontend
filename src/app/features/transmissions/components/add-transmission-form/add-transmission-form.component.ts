...
export class AddTransmissionFormComponent implements OnInit {
  ...
  constructor(
    ...
    private transmissionServices: TransmissionsControllerService,
  ...
  add() {
    const request: AddTransmissionRequestParams = {
      createTransmissionRequest: {
        name: this.form.value.name,
      },
    };

    this.transmissionServices.addTransmission(request).subscribe({
